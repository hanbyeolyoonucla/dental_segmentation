...
class SegmentationCaries(BasicInferTask):
    """
    ...
    def __init__(
        ...
        labels=None,
        dimension=3,
        description="A pre-trained model for volumetric (3D) segmentation of the caries from CT image",
        **kwargs,
    ):
        super().__init__(
            path=path,
